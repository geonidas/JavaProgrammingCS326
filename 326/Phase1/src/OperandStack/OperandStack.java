...
public class OperandStack {
     ...
     **/
    private int sp = 0; //changed

    /**
     * Top of stack. the value contained in the top of the stack
     */

    private Value top; //changed
    ...
    public void push(Value e) {
      if(sp == stackSize-1) //checking if full
      {
